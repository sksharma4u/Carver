                     ...
                     <Card.Body className=" profile-page p-0">
                        <div className="profile-header">
                           ...
                           <div className="user-detail text-center mb-3">
                              <div className="profile-img" style = {{float: 'left' , marginLeft: '40px'}}>
                                 <img src={img2} alt="profile-img1" className="avatar-130 img-fluid"  style = {{ height: '157px' , width: '146px'}}/>
                              </div>
                              <div className="profile-detail" style={{float: 'left',marginTop: '69px' ,marginLeft: '24px'}}>
                                 <h3> Kevin </h3>
                              </div>
                           </div>
                           <div className="profile-info p-3 d-flex align-items-center justify-content-between position-relative">
                              <div className="social-links" style = {{marginLeft:'189px' , marginTop : '46px'}}>
                                 <ul className="social-data-block d-flex align-items-center justify-content-between list-inline p-0 m-0" style = {{marginTop: '60px'}}>
                              ...
                              <div className="social-info" style = {{marginTop: '36px'}}>
