...
import img10 from '../../assets/images/small/img-2.jfif'
                            ...
                            <Card.Body>
                                <ul className="suggested-page-story m-0 p-0 list-inline">
                                    <li className="mb-3">
                                        ...
                                        <div className="mt-3" onClick={inc}><Link to="#" className="btn d-block" ><i className="ri-thumb-up-line me-2"></i> {count} Likes</Link></div>
                                    </li>
                                    <li>
                                        <div className="d-flex align-items-center mb-3">
                                            <img src={img42} alt="story-img" className="rounded-circle img-fluid avatar-50"/>
                                        ...
                                        <div className="mt-3" onClick={add}><Link to="#" className="btn d-block"><i className="ri-thumb-up-line me-2"></i> {value} Likes</Link></div>
                                    </li>
                                </ul>
                            </Card.Body>
                        </Card>
                            ...
                            <Card id="post-modal-data" className="card-block card-stretch card-height">
                                ...
                                <Card.Body >
                                    <div className="d-flex align-items-center">
                                        <div className="user-img" style = {{marginRight :'10px'}}>
                                            <img src={user1} alt="user1" className="avatar-60 rounded-circle"/>
                                        </div>
                                        <form className="post-text w-100 "   onClick={handleShow} style = {{ border:'1px solid black' , borderRadius:'7px'}}>
                                    ...
                                    <ul className=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap">
                                        <li className="mb-md-0 mb-2" style={{width: '30%', display:'flex'}}>
                                            <Link to="#" className="btn" style={{ display:'flex'}}>
                                                <img src={img1} alt="icon" className="img-fluid" style={{marginRight: '0.275rem'}}/> Photo/Video
                                            </Link>
                                        </li>
                                        <li className="mb-md-0 mb-2" style={{width: '30%'}}>
                                            <Link to="#" className="btn" style={{ display:'flex'}}>
                                                <img src={img2} alt="icon" className="img-fluid" style={{marginRight: '0.275rem'}} /> Tag Friend
                                            </Link>
                                        </li>
                                        <li style={{width: '25%'}}>
                                            <Link to="#" className="btn"style={{ display:'flex'}}>
                                                <img src={img3} alt="icon" className="img-fluid" style={{marginRight: '0.275rem'}} /> Activity
                                            </Link>
                                        </li>
                                        <li style={{width: '10%'}}>
                                            <button className="btn" style={{marginRight: '-0.175rem', display:'flex'}} >
                                                <div className="card-header-toolbar d-flex align-items-center">
                                                    <Dropdown>
                            ...
                            <Card className=" card-block card-stretch card-height">
                                <Card.Body>
                                    <div className="user-post-data">
                                        ...
                                        <div className="mt-3">
                                            <p>Thank you so much, Microsoft and Pablo Veramendi for sending me this amazing beta swag kit. The journey till now has been so fun and informative. I love the community and the members as they are so energetic and active helping us to learn and grow more.
                                                I bet the journey ahead will be all the more fun and amazing.
                                                <span style = {{color : '#0a66c2'}}> #microsoftlearnstudentambassador #swags #micorsoft #community</span></p>
                                        </div>
